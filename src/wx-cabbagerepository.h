...
#ifndef _WX_CABBAGEREPOSITORY_H_
#define _WX_CABBAGEREPOSITORY_H_


class wxCabbageRepository : public Gtk::EventBox //public Gtk::Frame
{
public:
	wxCabbageRepository();
	virtual ~wxCabbageRepository();
...
#endif // _WX_CABBAGEREPOSITORY_H_
