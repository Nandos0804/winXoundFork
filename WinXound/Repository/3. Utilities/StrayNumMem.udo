...
DESCRIPTION
Looks whether the number inum is a member of Stray. If yes, itest returns 1, if no, 0. Elements are defined by two seperators as ASCII coded characters: isep1 defaults to 32 (= space), isep2 defaults to 9 (= tab). If just one seperator is used, isep2 equals isep1.
Requires the UDOs StrayLen, StrayGetEl and StrNumP
